...
class LanrySpaceParser extends Parser{
    ...
    async getChapterUrls(dom) {
        ...
        let bookinfo = (await HttpClient.fetchJson(apibasetoc+slug+apikey)).json[0];
    ...
    chtitle(a){
        if (a.part_number == null) {
            return a.title != ""?a.title:"Ch."+a.chapter_number;
        } else {
            return a.title != ""?a.title:"Ch."+a.chapter_number + "-" + a.part_number;
        }
    }
    ...
    buildChapter(json, url) {
        ...
        if (json.title!="") {
            ...
            let chapterid = url.match(regex)[0].slice(2);
            title.textContent = "Ch." + chapterid;
        }
